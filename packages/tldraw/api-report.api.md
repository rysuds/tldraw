...
// @public (undocumented)
export const emojiBrushEmojiValidator: T.ObjectValidator<TLEmojiBrushEmoji>;
...
export class EmojiBrushShapeUtil extends ShapeUtil<TLEmojiBrushShape> {
    ...
    // (undocumented)
    expandSelectionOutlinePx(shape: TLEmojiBrushShape): number;
    // (undocumented)
    getDefaultProps(): TLEmojiBrushShape['props'];
    // (undocumented)
    getGeometry(shape: TLEmojiBrushShape): Polyline2d;
    // (undocumented)
    getInterpolatedProps(startShape: TLEmojiBrushShape, endShape: TLEmojiBrushShape, t: number): TLEmojiBrushShapeProps;
    // (undocumented)
    indicator(shape: TLEmojiBrushShape): JSX_2.Element | null;
    // (undocumented)
    ...
    // (undocumented)
    toSvg(shape: TLEmojiBrushShape, _ctx: SvgExportContext): JSX_2.Element;
    // (undocumented)
